			...
			<div class="header-content">
	            <div class="main-nav">
	                    <ul>
	                        ...
	                        <li><a href="livres_demendes.php">Livres demandés</a></li>
	                    </ul>
	            </div>
	              <div class="account" id="account">
	                        <img src="src/images/users/<?php echo $_SESSION['id']; ?>.jpg?filemtime(src/images/users/<?php echo $_SESSION['id']; ?>.jpg)" alt="">
	            ...
	            <div class="topmenu hide" id="topbar-menu">
	                    <a href="my_info.php"><i class="ion-person"></i> Mon compte </a>
	                    <a href="livres_demendes.php"><i class="ion-briefcase"></i> Livres demandés </a>
